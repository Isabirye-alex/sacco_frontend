...
_Generated: 2026-06-18T20:12:08.467Z_
...
Workspace `mcp.json` _(folder: sacco_frontend)_

- **d:\Front\sacco_frontend\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Tariq\AppData\Roaming\Code\User\mcp.json** — _File missing_
